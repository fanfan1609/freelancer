...
class modframework {
	...
	public function initframework(){
		...
		if(strpos($_SERVER['PHP_SELF'],'admin') !== false) $load = ''; else $load = 'AND backend_only != 1 ';
		//Set current page
	...
	public function show_admin_menu(){
		...
		if($this->is_17()){
	        ...
	        <a href="mm_plugins.php"><img src="img/ico-plugins.png" width="26" height="26"> <span>Plugins</span></a>
	        </li>';
		}else{
			echo '<li><a href="mm_plugins.php" '.(($showm==12)? 'class="selectedm"':'').'>Plugins</a></li>';
		}
	}
	/**
	...
	public function getactiveplugins(){
		...
		while($obj = mysql_fetch_object($res)){
			if($obj->active==1){
				...
				<td align="center" class="table-col-action" style="text-align:center; width: 90px;"><form method="post" action="mm_plugins.php?do=deactivate" style="margin:0px;" class="'.$obj->plugin.'_act"><input type="hidden" name="plugin" value="'.$obj->plugin.'" /><a href="javascript: void(0);" onClick="actplugin(\''.$obj->plugin.'\');" rel="tooltip" title="Deactivate this plugin" class="btn btn-mini btn-link"><i class="icon-remove-sign"></i></a><a href="mm_settings.php?mod='.$obj->plugin.'" class="btn btn-mini btn-link" rel="tooltip" title="Settings"><i class="icon-wrench"></i></a></form></td></tr>';

			}else{
				echo '<tr><td align="center" style="text-align:center"><span class="label">inactive</span></td><td><em>'.$obj->plugin_name.'</em>
				<td align="center" class="table-col-action" style="text-align:center; width: 90px;"><form method="post" action="mm_plugins.php?do=activate" style="margin:0px;" class="'.$obj->plugin.'_act"><input type="hidden" name="plugin" value="'.$obj->plugin.'" /><a href="javascript: void(0);" onClick="actplugin(\''.$obj->plugin.'\');" rel="tooltip" title="Activate this plugin" class="btn btn-mini btn-link"><i class="icon-ok-sign"></i></a><a href="mm_settings.php?mod='.$obj->plugin.'" class="btn btn-mini btn-link" rel="tooltip" title="Settings"><i class="icon-wrench"></i></a></form></td></tr>';
			}
		}
		return true;
	}
