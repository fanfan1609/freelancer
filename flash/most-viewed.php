...
$modframework->trigger_hook('most-viewed_top');
...
$categories_list = preg_replace('/value="(.*?)"/', 'value="'. _URL .'/most-viewed.'. _FEXT .'?c=$1"', $categories_list);
...
{
	$filename = (_SEOMOD) ? 'most-viewed.html' : 'most-viewed.php';
...
$meta_title = 'Most Viewed Zoology Videos | FlockShare';
if(!empty($date)) {
...
$meta_title = sprintf($meta_title, 'Zoology Videos | FlockShare');
...
$modframework->trigger_hook('most-viewed_bottom');
