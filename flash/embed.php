	...
	<?php if ( ! $video) : // video not found ?>
		...
		<p>
			<?php if ($config['custom_logo_url'] != '') : ?> 
				<div class="embed_logo" align="center"><a href="<?php echo _URL;?>" target="_blank"><img src="<?php echo $config['custom_logo_url'];?>" alt="<?php echo 'Travel Videos | FlockShare';?>" title="<?php echo 'Travel Videos | FlockShare';?>" border="0"></a></div>
			<?php else : ?>
				<h3><a href="<?php echo _URL;?>" target="_blank"><?php echo 'Travel Videos | FlockShare';?></a></h3>
			<?php endif; ?>
		</p>
</body>
</html>
