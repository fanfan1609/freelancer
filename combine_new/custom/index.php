...
function processSubmit($isEmail=false)
{
	...
	if ($result === false)
		...
		if ((isset($_POST['save'])) || (isset($_POST['csv'])) && (!$isEmail))	exit;
			else if (!$isEmail)  echo '<br>' . $language['completed'] . '</p>';
	}
}
/*
if ($emailResults)
...
<br/>
<p class="firstp">
<b>Maximum Domains Checkable : <?php if (MAX_DOMAINS_AT_ONE_TIME == -1) {echo   'Unlimited';} 
	else
	{
...
<tr>
<td><textarea class="span6 m-wrap" rows="3"name="domains" style="height:150px; width:600px;"><?php if (isset($_REQUEST['domains'])) { echo $_REQUEST['domains']; } else { ?><?php } ?></textarea></td>
<td><input type="submit" class="btn green" style="height:150px;"name="submit" value="<?php echo $language['check_availability']?>"></td>
</tr>
</table>
</div>
</div>
...
<label for="onlyavailable" class="control-label"> <?php echo $language['only_available']?></label>									
<br/>
<div class="controls">
...
<div class="control-group " style=" display: inline-block;
    ...
    margin: auto;
    text-align: center;">
<label class="control-label" for="save" style=""><?php echo $language['save_as_text_file']?></label>
<br/>
<div class="controls">
